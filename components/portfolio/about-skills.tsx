...
export function About() {
  return <section id="about" data-scene="about" className="portfolio-section about-section">
...
export function Skills() {
  return <section id="skills" data-scene="skills" className="portfolio-section">
