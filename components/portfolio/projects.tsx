...
export function Projects() {
  return <section id="projects" data-scene="projects" className="portfolio-section"><SectionHeading label="SELECTED WORK" title="Ideas, out in the real world." description="Thoughtful technology. Real problems. A reason to build." />
